...
function text_hover(){
	...
	wp_enqueue_style( 'text-hover', get_template_directory_uri() . '/css/text-hover.css' , array(), '1.0', 'all');
	wp_enqueue_script( 'text-hover', get_template_directory_uri() . '/js/text-hover.js', array(), null, true);

}

add_action( 'wp_enqueue_scripts', 'text_hover' );

function zoom_hover(){

	wp_enqueue_style( 'zoom-hover', get_template_directory_uri() . '/css/zoom-hover.css' , array(), '1.0', 'all');
	wp_enqueue_script( 'zoom-hover', get_template_directory_uri() . '/js/zoom-hover.js', array(), null, true);

}

add_action( 'wp_enqueue_scripts', 'zoom_hover' );