	...
	*/
	final class Wow_Company{
		...
		public function style(){
			wp_enqueue_style('wow-company', plugin_dir_url(__FILE__) . 'css/style.min.css', null, $this->version);
		...
		public function main_page() {
			...
			wp_enqueue_style( 'wow-company-icon', plugin_dir_url(__FILE__) . 'fontawesome/fontawesome.min.css', array(), '4.7.0' );
		}		
