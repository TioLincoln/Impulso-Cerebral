		...
		private function table_data()
		{
			...
			if ($resultat) {				
				foreach ($resultat as $key => $value) {					
					$data[] = array(
					'ID' => $value->id,	
					'title'  => '<a href="admin.php?page='.$this->pluginname.'&tool=add&act=update&id='.$value->id.'">'.$value->title.'</a>',
					'code'  => '['.$this->shortcode.' id="'.$value->id.'"]',					
					'edit' => '<a href="admin.php?page='.$this->pluginname.'&tool=add&act=update&id='.$value->id.'">edit</a>',
					'delete' => '<a href="admin.php?page='.$this->pluginname.'&info=del&did='.$value->id.'" style="color:red;">delete</a>',
					'duplicate' => '<a href="admin.php?page='.$this->pluginname.'&tool=add&act=duplicate&id='.$value->id.'" style="color:green;">duplicate</a>',					
					);				
				}	
			}
			return $data;	
